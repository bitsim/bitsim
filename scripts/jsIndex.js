//javascript for bitsim/index.html by cturner314
  ...
  switch (Mode) {
    ...
    case "Analyse":
      if (capitalOption == 0 || bet == 0) {
        ...
        document.getElementById("Break25Lbl").innerHTML =
          "Breakeven - Bet " + twentyfive;
        document.getElementById("Break50Lbl").innerHTML =
          "Breakeven - Bet " + fifty;
        document.getElementById("Break75Lbl").innerHTML =
          "Breakeven - Bet " + seventyfive;
        document.getElementById("Break100Lbl").innerHTML =
          "Breakeven - Bet " + i;
        ...
        for (e = 0; Aloss2 <= capital; e++) {
          ...
          switch (e) {
            case 0:
              document.getElementById("Aroll1").innerHTML = Math.round(
                b * 10 ** 8
              );
              break;

            case 1:
              document.getElementById("Aroll2").innerHTML = Math.round(
                b * 10 ** 8
              );
              break;

            case 2:
              document.getElementById("Aroll3").innerHTML = Math.round(
                b * 10 ** 8
              );
              break;

            case 3:
              document.getElementById("Aroll4").innerHTML = Math.round(
                b * 10 ** 8
              );
              break;

            case 4:
              document.getElementById("Aroll5").innerHTML = Math.round(
                b * 10 ** 8
              );
              break;
            ...
            case twentyfive:
              ...
              document.getElementById("Profit25Lbl").innerHTML =
                "AVG. PROFIT (1-" + twentyfive + ")";
            ...
            case fifty:
              ...
              document.getElementById("Profit50Lbl").innerHTML =
                "AVG. PROFIT (" + Avg50 + "-" + fifty + ")";
              if (b * payout - Aloss2 > 0) {
            ...
            case seventyfive:
              ...
              var Avg75 = fifty + 1;
              document.getElementById("Profit75Lbl").innerHTML =
                "AVG. PROFIT (" + Avg75 + "-" + seventyfive + ")";
              if (b * payout - Aloss2 > 0) {
            ...
            case i:
              ...
              document.getElementById("Profit100Lbl").innerHTML =
                "AVG. PROFIT (" + Avg100 + "-" + i + ")";
              if (b * payout - Aloss2 > 0) {
...
function Roll() {
  if (capital - currentBet < 0) {
    alert(
      "Auto roll stopped after " +
        totalRolls +
        " bets due to insufficient capital"
    );
    InitRoll();
    return "stopped";
  }
...
function DisplayRolls(r, s) {
  ...
  document.getElementById("roll5").innerHTML =
    last5Rolls[last5Rolls.length - 1];
  ColorRolls("roll5", 1);
  document.getElementById("roll4").innerHTML =
    last5Rolls[last5Rolls.length - 2];
  ColorRolls("roll4", 2);
  document.getElementById("roll3").innerHTML =
    last5Rolls[last5Rolls.length - 3];
  ColorRolls("roll3", 3);
  document.getElementById("roll2").innerHTML =
    last5Rolls[last5Rolls.length - 4];
  ColorRolls("roll2", 4);
  document.getElementById("roll1").innerHTML =
    last5Rolls[last5Rolls.length - 5];
  ColorRolls("roll1", 5);
}
